...
export default function CreateProjectModal() {
  ...
  const defaultHtml = "<html><head></head><body></body></html>"
  const defaultCss = ".body{}"
  const defaultJavascript = "function helloWorld(){console.log('hello world')}"
  ...
  function setDefaults(){
    setData({...data, html: defaultHtml})
    setData({...data, css: defaultCss})
    setData({...data, javascript: defaultJavascript})
  }
  setDefaults();
  useEffect(() => {
    setData((prev) => ({
  ...
  return (
    <form
      action={async (data: FormData) =>
        createProject(data).then((res: any) => {
          if (res.error) {
    ...
    >
      <div className="relative flex flex-col space-y-4 p-5 md:p-10">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <textarea
            name="description"
            placeholder="Description about why my project is so awesome"
